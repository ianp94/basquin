# DD-043 PR-3 verification — 20260730T054112Z

Commit: `9f1e990` on `dd043-pr3-maven-injector` — tree clean at run start (`git-status.txt`)
...
| PASS | `jvm:boundary` | poll returned 782,-767,9\|0\|\| |
...
Poll returned `782,-767,9|0||`. The fields are latency, heap delta, threads.
