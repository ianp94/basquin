# DD-043 PR-3 verification — 20260730T102725Z

Commit: `6e67ca7` on `dd043-pr3-maven-injector` — tree clean at run start (`git-status.txt`)
...
| PASS | `jvm:boundary` | poll returned 794,2139,8\|0\|\| |
...
Poll returned `794,2139,8|0||`. The fields are latency, heap delta, threads.
