# DD-043 PR-3 verification — 20260729T153141Z

Commit: `a61a90c` on `dd043-pr3-maven-injector`
...
|---|---|---|
| PASS | `unit` | 382 tests, 0 failures |
...
| PASS | `jvm:not-from-central` | com/basquin resolution happened and none of it came from central |
...
| PASS | `jvm:boundary` | poll returned 768,-768,9\|0\|\| |
...
Poll returned `768,-768,9|0||`. The fields are latency, heap delta, threads.
