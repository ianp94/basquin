# DD-043 PR-3 verification — 20260730T042822Z

Commit: `e959e7d` on `dd043-pr3-maven-injector` — tree clean at run start (`git-status.txt`)
...
| PASS | `jvm:boundary` | poll returned 781,844,9\|0\|\| |
...
Poll returned `781,844,9|0||`. The fields are latency, heap delta, threads.
