...
public class DbServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        String url = System.getProperty("basquin.demo.db.url",
                System.getenv().getOrDefault("BASQUIN_DEMO_DB_URL", "jdbc:mysql://mysql:3306/demo?user=root&password=basquin"));
        int size = getIntProp("basquin.demo.db.poolSize", System.getenv("BASQUIN_DEMO_DB_POOL"), 2);
