...
(`bench-results/verify-20260730T102725Z/suite-counts.txt:1`).
...
0. **DD-043 PR-3 — `basquin-maven-injector` — done, open as
   ...
   run of record, not from either acceptance directory: `bench-results/verify-20260730T102725Z/`
   ...
   **Both acceptances are single-module, and no multi-module Maven reactor was ever built end-to-end
   ...
   (`bench-results/verify-20260730T102725Z/RESULTS.md`) omits this gap; that file is fixed evidence and
   ...
   **Every branch that can throw carries its own mutation row — there is no uncovered guard.**
   ...
   `bench-results/verify-20260730T102725Z/RESULTS.md` as one `guards:<label>` row apiece, alongside
