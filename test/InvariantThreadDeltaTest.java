...
public class InvariantThreadDeltaTest {

    @Test
    public void threadDeltaThresholdShouldFail() throws IOException, InterruptedException {
        ...
        assertNotEquals("Run should exit non-zero due to thread delta invariant", 0, exit);
